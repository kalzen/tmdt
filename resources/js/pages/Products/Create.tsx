        ...
        return (
            <div key={item.id} className="catalogue-item">
                ...
                {hasChildren && isExpanded && (
                    <div className="catalogue-children">
...
export default function CreateProduct({ catalogues, catalogueTree, stores, attributes, defaultStoreId }: Props) {
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        store_id: defaultStoreId ? defaultStoreId.toString() : '',
        is_active: true,
        is_featured: false,
        meta_title: '',
        meta_description: '',
    ...
    // Add "None" option if there's more than one store
    if (stores.length > 1) {
