...
export default function Edit({ member }: Props) {
  ...
  const [preview, setPreview] = useState<string | null>(member.avatar);
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-2xl font-semibold">Chỉnh Sửa: {member.name}</h1>
          </div>
              ...
              <div className="lg:col-span-2 space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Cập nhật thông tin cơ bản của thành viên
                    </CardDescription>
                  </CardHeader>
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-end">
                  <Button type="submit" className="w-full" disabled={processing}>
                    {processing ? 'Đang lưu...' : 'Cập nhật thành viên'}
                  </Button>
                </div>
              </div>
            </div>
